      ...
      <section className="bg-secondary text-white py-20 relative overflow-hidden">
        <div className="container mx-auto px-4 relative z-10 flex flex-col md:flex-row items-center justify-between gap-8">
          <div className="space-y-4 text-center md:text-left">
            ...
            <p className="text-lg md:text-xl text-white/80 font-bold uppercase tracking-widest">
              Our technicians are ready to roll 24/7.
            </p>
          </div>
          <a href="tel:8447408904" className="bg-white text-secondary font-black py-4 md:py-6 px-8 md:px-12 rounded-2xl shadow-2xl hover:bg-gray-100 transition-all active:scale-95 uppercase italic tracking-widest text-xl md:text-2xl">
            Call (844) 740-8904
          </a>
        </div>
      </section>
