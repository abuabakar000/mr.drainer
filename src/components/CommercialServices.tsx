  ...
  return (
    <section className="py-24 relative overflow-hidden bg-white">
      ...
      <div className="absolute inset-0 z-0 opacity-10 grayscale pointer-events-none">
        <Image 
          src="/commercial-popular-bg.png" 
          alt="Commercial Plumbing Environment" 
          fill 
      ...
      <div className="container mx-auto px-4 max-w-7xl relative z-10">
        <div className="max-w-4xl mb-16">
          <h2 className="text-4xl md:text-5xl font-black text-primary mb-6 leading-tight italic uppercase tracking-tighter">
            Mr. Drainer Plumbing <br />
            <span className="text-secondary tracking-tighter">Commercial Plumbing</span> Services
          </h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 pt-8">
          {services.map((service, i) => (
            <div key={i} className="group bg-white p-8 md:p-12 rounded-[2rem] shadow-2xl border border-gray-50 hover:border-primary transition-all duration-300 transform hover:-translate-y-2 flex flex-col items-center text-center cursor-pointer">
