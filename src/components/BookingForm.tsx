...
export default function BookingForm({ defaultTab: initialTab = 'Residential' }: BookingFormProps) {
  ...
  if (submitted) {
    return (
      <div id="booking-section" className="bg-white border-y border-gray-100 py-16 md:py-24 relative overflow-hidden text-center animate-in zoom-in duration-500 min-h-[400px] flex flex-col items-center justify-center">
  ...
  return (
    <div id="booking-section" className="bg-white border-y border-gray-100 py-10 md:py-24 relative overflow-hidden group">
      <div className="container mx-auto px-4 max-w-7xl">
        ...
        <div className="lg:w-1/3">
          ...
          <h2 className="text-2xl md:text-3xl font-black text-primary mb-4 italic uppercase tracking-tighter">
        ...
        <div className="lg:w-2/3 w-full">
          <form onSubmit={handleSubmit} className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="space-y-2">
              ...
              <input required type="text" placeholder="Enter First Name*" className="w-full bg-white border-2 border-gray-100 p-4 md:p-5 rounded-2xl focus:outline-none focus:border-secondary shadow-sm hover:shadow-md transition-all font-bold text-primary placeholder:text-gray-400 placeholder:font-black placeholder:uppercase placeholder:text-[10px] placeholder:tracking-widest" />
            </div>
            <div className="space-y-2">
            ...
            <div className="flex items-end">
              <button 
                disabled={loading}
                type="submit" 
                className="w-full bg-secondary hover:bg-red-700 text-white font-black py-4 md:py-6 px-8 rounded-2xl transition-all shadow-[0_10px_30px_rgba(227,27,35,0.3)] active:scale-95 uppercase italic tracking-widest flex items-center justify-center gap-3 disabled:opacity-50 cursor-pointer h-[60px] md:h-[68px]"
              >
