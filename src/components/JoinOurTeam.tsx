        ...
        <div className="bg-white rounded-3xl shadow-[0_20px_50px_rgba(0,0,0,0.1)] overflow-hidden flex flex-col lg:flex-row items-stretch border border-gray-100 p-4 md:p-8">
          <div className="lg:w-1/2 p-8 md:p-12 flex flex-col justify-center">
            ...
            <div className="space-y-6">
              ...
              <p className="text-gray-600 font-medium leading-[1.8] text-lg">
                Creating a culture with an exemplary work ethic is just as important as plumbing, and it&apos;s part of everything Mr. Rooter Plumbing does.
              </p>
            ...
            <div className="mt-12">
              <button className="bg-primary hover:bg-blue-800 text-white font-black py-5 px-10 rounded-xl transition-all shadow-xl active:scale-95 uppercase italic tracking-widest flex items-center gap-3 w-fit">
